...
Save Safe? No* (you could manually restore any missing mods to preserve an ongoing campaign)
...
4. ADDED the latest GraphicFade mod for Barbarian-focused equipment, and integrated it into the attunement system.
...
11. Updated something like 20 mods.
