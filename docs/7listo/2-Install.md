...
- **Your total number of active mods should be 572, and the purple seperator at the top should say Listonomicon v3.3.1. Total active mods should be 391 for Listo Lite, and the seperator should say Listonomicon v3.3.1 Lite.**
