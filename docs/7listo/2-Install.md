...
- **Your total number of active mods should be 603, and the purple seperator at the top should say Listonomicon v3.5.5. Total active mods should be 410 for Listo Lite, and the seperator should say Listonomicon v3.5.**
