...
- **Your total number of active mods should be 519. The purple separator at the top of your mod list should say Listonomicon v2.5.1**
...
- Everything else should default to the right values. If not, hit "Restore default values" and it should update.
