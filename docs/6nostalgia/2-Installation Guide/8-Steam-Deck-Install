...
:::info
## This guide is Originally for Capital Punishment, but will work for Nostalgia just the same!
:::

:::caution
## **Community Guide: Nostalgia Steam Deck/Linux Installation**
...
These steps will need to be carried out in Desktop mode, but once complete you will be able to launch the Modlist and play the game from Game Mode. This guide assumes you have installed Nostalgia on your Windows system and can successfully load and play the modlist. I also assume that you have set a user password on the Steam Deck and have a preferred method for transferring data from your Windows System to the deck (Rsync, WinSCP, whatever). As far as I am aware, New Vegas must be installed on the internal drive of the deck, and not an SDCard, but I am still trying to see if that is possible.

### Step 1 - **Install Fallout New Vegas**
Install the game on your Steam Deck and set the Proton compatibility to the latest Steam stable version, which as of now is 8.0-2. You can of course use alternative Proton versions such as ProtonGE, more on this in Step 9 at the end of the guide.
...
Then enter the path you want to store the modlist. I chose to store the list in /home/deck/Games/Fallout/Nostalgia:
...
Next, select Portable, then New Vegas
...
MO2 itself should now load, though it may complain that the profile 'default' doesn't exist, so it will use "Nostalgia" instead:
...
Finally, once MO2 has loaded, ensure that it lists mods in the left hand of the window:
...
Edit the executable paths for NVSE, New Vegas and Fallout Launcher to be the respective paths in /home/deck/Games/Fallout/Nostalgia/modorganizer2/Stock Game. E.g for NVSE, click the browse button/three dots next to the Binary path:

![image](https://github.com/TheMrNewVegas/TheMrNewVegas.github.io/assets/112358568/eedfbb08-747d-40b9-8d50-a426d80e6eb0)


Browse to the path /home/deck/Games/Fallout/Nostalgia/modorganizer2/Stock Game, highlight the nvse_loader.exe file, and click OK:

![image](https://github.com/TheMrNewVegas/TheMrNewVegas.github.io/assets/112358568/b242a713-31f1-4bcf-898a-cc65f2dab4ef)


Set the Start In path to be Z:\home\deck\Games\Fallout\Nostalgia\modorganizer2\Stock Game:

![image](https://github.com/TheMrNewVegas/TheMrNewVegas.github.io/assets/112358568/daed032b-5244-489e-8f2d-1e726f4a3456)


Do the same for the "New Vegas" and "Fallout Launcher" executable entries:
...
``wget https://github.com/Omni-guides/Wabbajack-Modlist-Linux/raw/main/docs/FNV_CapitalPunishment_dxvk.conf -O /home/deck/Games/Fallout/Nostalgia/modorganizer2/Stock\ Game/dxvk.conf``
...
Accept the Graphics options, and now it's finally time to play! Set the Launch option back to New Vegas, and click Play:
