...
- **Listonomicon: Your total number of active mods should be 831, and the purple seperator at the top should say Listonomicon v7.0.10 Slime Edition**
- **Listonomicon Lite: For Listo Lite, your total active mods should be 558, and the seperator should say Listo Lite v7.0.8 Slime Edition**
