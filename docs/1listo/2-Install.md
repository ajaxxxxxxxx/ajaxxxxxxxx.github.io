...
- **Listonomicon: Your total number of active mods should be 668, and the purple seperator at the top should say Listonomicon v6.0.1**
- **Listonomicon Lite: For Listo Lite, your total active mods should be 457, and the seperator should say Listo Lite v6.0.1**
