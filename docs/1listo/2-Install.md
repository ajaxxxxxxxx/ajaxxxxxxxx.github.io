...
- **Listonomicon: Your total number of active mods should be 817, and the purple seperator at the top should say Listonomicon v7.1.3 Slimed Edition**
- **Listonomicon Lite: For Listo Lite, your total active mods should be 554, and the seperator should say Listo Lite v7.1.1 Slimed Edition**
